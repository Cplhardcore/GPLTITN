...
//*****************************************************************************//
//
//	gjb_itn_fnc_deviceMawl
//
//	Takes input from Interface and controls general and unique device features for the MAWL laser
//	 aiming device.
//
...
//Functions
		...
		_interfaceChangeMode = {
			...
			private _knob = ["VAL_co.paa","OFF_co.paa","AL_co.paa","DL_co.paa","AH_co.paa","IH_co.paa","DH_co.paa"];
																								// "P_co.paa" as #2
			...
			if(_deviceState #0 > 0 && (_newKnob == 0 || _newKnob == 1 || _irCheck == 0))then{
		...
		_openInterface = {
			...
			private _mode = _deviceState #4;
			private _knobOps = ["VAL_co.paa","OFF_co.paa","AL_co.paa","DL_co.paa","AH_co.paa","IH_co.paa","DH_co.paa"];
																										// "P_co.paa" as #2
