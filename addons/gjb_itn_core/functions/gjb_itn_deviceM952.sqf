...
//*****************************************************************************//
//
//	gjb_itn_fnc_deviceM952
//
//	Takes input from Interface and controls general and unique device features for the M952V weapon light.
//
...
//Functions
		...
		_interfaceChangeMode = {
			...
			private _knob = ["VIS_co.paa","OFF_co.paa","IR_co.paa"];
		...
		_openInterface = {
			...
			private _mode = _deviceState #4;
			private _knobOps = ["VIS_co.paa","OFF_co.paa","IR_co.paa"];
