...
//*****************************************************************************//
//
//	gjb_itn_fnc_devicePeq16
//
//	Takes input from Interface and controls general and unique device features for the PEQ-16 laser
//	 aiming device.
//
...
//Functions
		...
		_interfaceChangeMode = {
			...
			private _knob = ["VD_co.paa","VL_co.paa","VA_co.paa","OFF_co.paa","AL_co.paa","DL_co.paa","AH_co.paa","DH_co.paa"];
																								// "P_co.paa" as #2
		...
		_openInterface = {
			...
			private _mode = _deviceState #4;
			private _knobOps = ["VD_co.paa","VL_co.paa","VA_co.paa","OFF_co.paa","AL_co.paa","DL_co.paa","AH_co.paa","DH_co.paa"];
																										// "P_co.paa" as #2
