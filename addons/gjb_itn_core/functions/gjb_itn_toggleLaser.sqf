...
//*****************************************************************************//
//	
//	gjb_itn_fnc_zm_toggleLaser
//
//	Allows curators to toggle AI unit's lasers on/off
//
//*****************************************************************************//
...
private _deviceC = [_a] call gjb_itn_fnc_hasCompat;

private _cfg = configFile >> "CfgITNCompat" >> "accessories" >> _deviceC;
...
private _deviceState = _unit getVariable ["gjb_itn_deviceState",[0,1,1,1,0,0]];
...
//Sets mode to default + 1 as temporary measure until has menu window
