...
//Functions
		...
		_mode2knob  = {
			...
			private _knobOps1 = ["OFF_co.paa","AL_co.paa","DL_co.paa","AH_co.paa","DLH_co.paa","DH_co.paa"];
			private _knobOps2 = ["VIS_co.paa","OFF_co.paa","IR_co.paa"];

			private _file1 = "";
			private _file2 = "";
			switch(_mode)do{
				case 0: {	//AIM LO + Vis Flash
					_file1 = _knobOps1 #1;
					_file2 = _knobOps2 #0;
					_comboMode = 1;
				};
				case 1: {	//DUAL LO + Vis Flash
					_file1 = _knobOps1 #2;
					_file2 = _knobOps2 #0;
					_comboMode = 1;
				};
				case 2: {	//AIM HI + Vis Flash
					_file1 = _knobOps1 #3;
					_file2 = _knobOps2 #0;
					_comboMode = 1;
				};
				case 3: {	//DUAL LO/HI + Vis Flash
					_file1 = _knobOps1 #4;
					_file2 = _knobOps2 #0;
					_comboMode = 1;
				};
				case 4: {	//DUAL HI/HI + Vis Flash
					_file1 = _knobOps1 #5;
					_file2 = _knobOps2 #0;
					_comboMode = 1;
				};
		...
		_interfaceChangeMode = {
			...
			private _knob1 = ["OFF_co.paa","AL_co.paa","DL_co.paa","AH_co.paa","DLH_co.paa","DH_co.paa"];
			...
			switch(_input)do{
				...
				case 1:{
					//previous mode
					_newKnob = _knobs #_ctrl;
					if(_newKnob > 0 ||  (_ctrl == 0 && _simpleCtrl && _newKnob > 1))then{
						_newKnob = _newKnob -1;
					}else{
						_shortStop = true;
					};
			...
			if(ctrl == 0 && _deviceState #0 > 0)then{
				switch(true)do{
					case (_newKnob == 0 && _deviceState == 1 && _comboMode == 1):{
						_deviceState set [0,3];
					};
					case (_newKnob == 0 && _deviceState == 1 && _comboMode == 2);
					case ( _newKnob == 0 && _deviceState == 2):{
			...
			private _newMode = 0;
			switch(true)do{
				case (_newKnob1 == 1 && _newKnob2 == 0): {	//AIM LO + Vis Flash
					_newMode = 0;
					_comboMode = 1;
				};
				case (_newKnob1 == 2 && _newKnob2 == 0): {	//DUAL LO + Vis Flash
					_newMode = 1;
					_comboMode = 1;
				};
				case (_newKnob1 == 3 && _newKnob2 == 0): {	//AIM HI + Vis Flash
					_newMode = 2;
					_comboMode = 1;
				};
				case (_newKnob1 == 4 && _newKnob2 == 0): {	//DUAL LO/HI + Vis Flash
					_newMode = 3;
					_comboMode = 1;
				};
				case (_newKnob1 == 5 && _newKnob2 == 0): {	//DUAL HI/HI + Vis Flash
					_newMode = 4;
					_comboMode = 1;
				};
				case (_newKnob1 == 0 && _newKnob2 == 0): {	//VIS Flash
					_newMode = 5;
					_comboMode = 3;
				...
				case (_newKnob1 == 0 && _newKnob2 == 1): {	//OFF
					_newMode = 6;
					_comboMode = 0;
				};
				case (_newKnob1 == 0 && _newKnob2 == 2): {	//IR Flash
					_newMode = 7;
					_comboMode = 3;
					if(_deviceState #0 > 0)then{
						_deviceState set [0,_comboMode];
				...
				case (_newKnob1 == 1 && _newKnob2 == 1):{	//AIM LO
					_newMode = 8;
					_comboMode = 2;
				};
				case (_newKnob1 == 1 && _newKnob2 == 2):{	//AIM LO + Flash
					_newMode = 9;
					_comboMode = 1;
				};
				case (_newKnob1 == 2 && _newKnob2 == 1):{	//DUAL LO
					_newMode = 10;
					_comboMode = 2;
				};
				case (_newKnob1 == 2 && _newKnob2 == 2):{	//DUAL LO + Flash
					_newMode = 11;
					_comboMode = 1;
				};
				case (_newKnob1 == 3 && _newKnob2 == 1):{	//AIM HI
					_newMode = 12;
					_comboMode = 2;
				};
				case (_newKnob1 == 3 && _newKnob2 == 2):{	//AIM HI + Flash
					_newMode = 13;
					_comboMode = 1;
				};
				case (_newKnob1 == 4 && _newKnob2 == 1):{	//DUAL LO/HI
					_newMode = 14;
					_comboMode = 2;
				};
				case (_newKnob1 == 4 && _newKnob2 == 2):{	//DUAL LO/HI + Flash
					_newMode = 15;
					_comboMode = 1;
				};
				case (_newKnob1 == 5 && _newKnob2 == 1):{	//DUAL HI/HI
					_newMode = 16;
					_comboMode = 2;
				};
				case (_newKnob1 == 5 && _newKnob2 == 2):{	//DUAL HI/HI + Flash
					_newMode = 17;
					_comboMode = 1;
				};
			};
			...
			if(_deviceState #0 > 0 && !(_deviceState #0 == 3 || _deviceState #4 == 5 || _deviceState #4 == 7))then{
				ctrlShow [999,true];
			}else{
				ctrlShow [999,false];
			};
		...
		_momentaryControl = {	//make like Peq2 control
